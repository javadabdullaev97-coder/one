...
export const allEngagements: Engagement[] = [
  ...
  { sector: "Public Sector",   metric: "UzFund", metricLabel: "State-owned",            headline: "Reorganization and structuring of an Uzbek state-owned investment fund",                                                                              disciplines: ["Legal", "Tax"] },
