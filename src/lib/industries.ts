...
export const allEngagements: Engagement[] = [
  ...
  { sector: "Public Sector",   metric: "Sole",   metricLabel: "State fund",             headline: "Reorganization and structuring of an Uzbek state-owned investment fund",                                                                              disciplines: ["Legal", "Tax"] },
