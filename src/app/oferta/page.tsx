...
export const metadata: Metadata = {
  title: "Публичная оферта | Advizen Consulting",
  description: "Публичная оферта на заключение договора купли-продажи информационных продуктов Advizen Consulting.",
};
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-16 md:py-20">
        ...
        <div className="mt-16 pt-10 border-t border-white/[0.06]">
          <p className="text-xs text-white/25 leading-relaxed">
            Настоящая оферта составлена в соответствии с Законом Республики Узбекистан «О защите прав потребителей»
            и иными актами законодательства Республики Узбекистан.
