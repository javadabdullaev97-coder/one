      ...
      <AuroraBackground>
        <section className="relative pt-24 pb-10 md:pt-28 md:pb-14">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
            ...
            >
              Reach out for a confidential consultation. We typically respond
          ...
          <div className="grid lg:grid-cols-[1fr_420px] gap-16 xl:gap-24 items-start">
                  ...
                  <button
                    ...
                    className={`mt-0.5 w-4 h-4 shrink-0 rounded border transition-all duration-200 cursor-pointer ${
                      agreed
                        ...
                        : "border-white/[0.18] bg-transparent hover:border-white/35"
                    }`}
                  />
                  <p className="text-[13px] text-white/45 leading-relaxed cursor-pointer select-none"
                    onClick={() => setAgreed((v) => !v)}>
                    I agree to the{" "}
                    <Link href="/privacy" className="underline underline-offset-2 hover:text-white/70 transition-colors">
                      Privacy Policy
                    </Link>{" "}
                    and consent to Advizen Consulting processing my data to respond
                    to this enquiry.
                  </p>
                </div>
            ...
            <div className="lg:pt-2">
              <StaggerContainer className="space-y-10">
                ...
                {/* Contact details */}
                <StaggerItem>
                  <h2 className="heading-luxury text-xl text-foreground mb-6">
                    Get in touch
                  </h2>
                  <div className="space-y-5">
                    {contactInfo.map(({ icon: Icon, label, value, href }) => (
                      <div key={label} className="flex items-start gap-4">
                        ...
                        <div>
                          <p className="text-[10px] uppercase tracking-[0.16em] text-white/35 mb-0.5">
                            {label}
                          </p>
                          {href ? (
                            <a
                              href={href}
                              className="text-sm text-white/65 hover:text-foreground transition-colors duration-200"
                            >
                              {value}
                            </a>
                          ) : (
                ...
                {/* Practice areas */}
                <StaggerItem>
                  <h3 className="text-xs uppercase tracking-[0.18em] text-white/35 mb-5">
                    Practice Areas
                  </h3>
